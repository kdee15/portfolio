  ...
  return (
    <>
      <nav className={classes.oNav}>
        ...
        <span
          className={`${classes.demoTab} ${classes.demoDesk} ${classes.show}`}
          name="demo-desk"
        >
          <figure className={classes.mIcon}>
            <svg
        ...
        <span
          className={`${classes.demoTab} ${classes.demoTab}  ${classes.show}`}
          name="demo-tab"
        >
          <figure className={classes.mIcon}>
            <svg
      ...
      <main className={classes.oProjects}>
        <section className={classes.oProjectContent}>
          {mobileView ? (
            <figure className={`${classes.oProjectCover} ${classes.on}`}>
              <Image
        ...
        <div
          className={`${classes.oTab} ${classes.slideContent} ${classes.on} ${classes.details}`}
          id="details"
        >
          <div
